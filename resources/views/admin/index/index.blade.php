...
<div class="container">
    <div class="logo">
        <a href="{{route('admin.index.index')}}">Admin</a></div>
    <div class="left_open">
...
<div class="left-nav">
    <div id="side-nav">
        <ul id="nav">
            @foreach($menu as $m)
                <li>
                    <a @if($m['url'] == "javascript:;") href="{{ $m['url'] }}" @else onclick="xadmin.add_tab('{{$m['name']}}','{{ $m['url'] }}')" @endif>
                        <i class="iconfont left-nav-li" lay-tips="{{ $m['name'] }}">&#xe726;</i>
                        <cite>{{ $m['name'] }}</cite>
                    ...
                    <ul class="sub-menu">
                        <li>
                            <a onclick="xadmin.add_tab('{{$mc['name']}}','{{ $mc['url'] }}')">
                                <i class="iconfont">&#xe6a7;</i>
                                <cite>{{$mc['name']}}</cite>
                            </a>
                        </li>
...
{{--            <li>--}}
                {{--                        <li>--}}
                {{--                            <a onclick="xadmin.add_tab('用户管理','{{ url('admin/admin') }}')">--}}
                {{--                                <i class="iconfont">&#xe6a7;</i>--}}
                {{--                                <cite>用户管理</cite></a>--}}
                {{--                        </li>--}}
                {{--                        <li>--}}
                {{--                            <a onclick="xadmin.add_tab('权限组管理','{{ route('admin.group.index') }}')">--}}
                {{--                                <i class="iconfont">&#xe6a7;</i>--}}
                {{--                                <cite>权限组管理</cite></a>--}}
                {{--                        </li>--}}
                {{--                        <li>--}}
                {{--                            <a onclick="xadmin.add_tab('菜单管理','{{route('admin.menu.index')}}')">--}}
                {{--                                <i class="iconfont">&#xe6a7;</i>--}}
                {{--                                <cite>菜单管理</cite></a>--}}
                {{--                        </li>--}}
    ...
    <div class="layui-tab tab" lay-filter="xbs_tab" lay-allowclose="false">
        ...
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                <iframe src='{{ route('admin.index.welcome') }}' frameborder="0" scrolling="yes" class="x-iframe"></iframe>
            </div>
        </div>
        <div id="tab_show"></div>
    </div>
