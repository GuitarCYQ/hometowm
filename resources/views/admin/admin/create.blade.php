...
@section('content')
    ...
    <div class="layui-fluid">
        <div class="layui-row">
            <form class="layui-form" action="{{route('admin.admin.store')}}">
                @csrf
...
{{--                            <input type="checkbox" class="group_id" value="{{$g['id']}}" name="group_id[]" lay-skin="primary" title="{{ $g['group_name'] }}">--}}
                            <input type="radio" checked class="group_id" value="{{$g['id']}}" name="group_id" lay-skin="primary" title="{{ $g['group_name'] }}">
                        @endforeach
                    </div>
                </div>
